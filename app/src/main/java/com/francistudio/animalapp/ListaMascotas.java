...
import com.francistudio.animalapp.adapter.PageAdapter;
import com.francistudio.animalapp.fragments.MascotaFragment;
import com.francistudio.animalapp.fragments.RecyclerViewFragment;
import com.francistudio.animalapp.menu.Acercade;
import com.francistudio.animalapp.menu.Contacto;
import com.francistudio.animalapp.pojo.Mascota;
...
public class ListaMascotas extends AppCompatActivity implements RecyclerViewFragment.RecyclerViewFragmentListener, MascotaFragment.MascotaFragmentListener {
    ...
    private void loadData(){
        ...
        if (mascotasList == null) {
            ...
            mascotasList.add(new Mascota(R.drawable.perro1, R.mipmap.bone_like,"Lorencho",2, R.mipmap.bone_count));
            mascotasList.add(new Mascota(R.drawable.perro2, R.mipmap.bone_like, "Linus",5, R.mipmap.bone_count));
            mascotasList.add(new Mascota(R.drawable.perro3, R.mipmap.bone_like, "Tati",6, R.mipmap.bone_count));
            mascotasList.add(new Mascota(R.drawable.perro4, R.mipmap.bone_like, "Chichi",4, R.mipmap.bone_count));
            mascotasList.add(new Mascota(R.drawable.perro5, R.mipmap.bone_like, "Mambita",3, R.mipmap.bone_count));
